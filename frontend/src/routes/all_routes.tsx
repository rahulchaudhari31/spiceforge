export const all_routes = {
  ...
  contact: "/contacts",
  links: "/ui-links",
  listGroup: "/ui-list-group",
  vehicleInspections: "/quality-control/vehicle-inspections",
  vehicleInspectionCreate: "/quality-control/vehicle-inspections/create",
  vehicleInspectionEdit: "/quality-control/vehicle-inspections/edit/:id",
  vehicleInspectionReview: "/quality-control/vehicle-inspections/review/:id",
  vehicleInspectionDetails: "/quality-control/vehicle-inspections/:id",
