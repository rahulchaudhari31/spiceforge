    ...
    <div className="row">
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">btn</span> class to show
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">btn-outline-</span> class
              with the below-mentioned variation to create a button with the
              outline.
            </p>
            <div className="d-flex align-items-center flex-wrap gap-2">
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">rounded-pill</span> class
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">btn-soft-</span> class
              with the below-mentioned variation to create a button with the
              soft background.
            </p>
            <div className="d-flex align-items-center flex-wrap gap-2">
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="d-flex flex-wrap gap-2">
              ...
              <button type="button" className="btn btn-warning bg-gradient">
                Warning
              </button>
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">bg-*-gradient</span>{" "}
            ...
            <div className="btn-list">
              ...
              <button type="button" className="btn  bg-info-gradient btn-info">
                Info
              </button>
              <button
                type="button"
              ...
              <button type="button" className="btn  bg-dark-gradient btn-dark">
                Dark
              </button>
            </div>
          </div>{" "}
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">btn-animation</span>{" "}
              class to create a animation effect.
            </p>
            <div className="btn-list">
              <button
                type="button"
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">btn-label</span> class to
            ...
            <div className="row row-gap-3">
              <div className="col-lg-4">
                <div className="d-flex flex-wrap gap-2">
                  ...
                  <button type="button" className="btn btn-warning btn-label">
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use <span className="text-secondary">btn-lg</span> class to create
              a large size button and{" "}
              <span className="text-secondary">btn-sm</span> class to create a
              small size button.
            </p>
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the{" "}
              <span className="text-secondary">data-bs-toggle="button"</span> to
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use <span className="text-secondary">btn-icon</span> class to wrap
              icon in button
            </p>
      ...
      <div className="col-xl-12">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-xl mb-3">
              Use the <span className="text-secondary">d-grid</span> class to
              create a full-width block button.
            </p>
