      ...
      <div className="row">
        <div className="col-xl-6">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <span className="placeholder d-block" style={{ width: "10%" }} />
            </div>{" "}
            {/* end card body */}
          </div>{" "}
          {/* end card */}
        ...
        <div className="col-xl-6">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                Create placeholders with the <code>.placeholder</code> class and
                a grid column class (e.g., <code>.col-6</code>) to set the{" "}
                <code>width</code>. They can replace the text inside an element
                or as be added as a modifier class to an existing component.
              </p>
              <p aria-hidden="true">
                <span className="placeholder col-6" />
              </p>
