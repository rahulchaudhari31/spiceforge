...
const ClipBoard = () => {
  ...
  const advancedParagrapto = useRef<HTMLSpanElement>(null);
                ...
                <div className="card-body">
                  <div className="clipboard">
                    <form className="form-horizontal">
                      <input
                        type="text"
                        className={`form-control mb-3 ${isCopied ? "clipboardcopyedvalue" : ""}`}
                        id="input-copy"
                        defaultValue="http://www.admin-dashboard.com"
                        ref={inputCopyRef}
                      />
                      <button
                        className="mb-1 btn clip-btn btn-primary me-2"
                        type="button"
                        onClick={handleCopy}
                      >
                        <i className="far fa-copy me-1" /> Copy from Input
                      </button>
                      <Link
                        onClick={handleCut}
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="clipboard">
                    <form className="form-horizontal">
                      <textarea
                        className={`form-control mb-3 ${isCopied1 ? "clipboardcopyedvalue" : ""}`}
                        rows={3}
                        id="textarea-copy"
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="clipboard copy-txt">
                    ...
                    >
                      <i className="far fa-copy me-1" /> Copy Link
                    </Link>
                    <Link
                    ...
                    >
                      <i className="far fa-copy me-1" /> Copy Hidden Code
                    </Link>
                  </div>
                </div>
              </div>
