...
export const SidebarData = [
    ...
    submenuItems: [
      ...
      },
      {
        ...
        submenuItems: [
          ...
          {
            label: "POS 6",
            link: "https://dreamspos.dreamstechnologies.com/restaurant-pos/react/login",
            showSubRoute: false,
            external: true,
          },
          {
            label: "POS 7",
            link: "https://dreamspos.dreamstechnologies.com/laundry-pos/react/login",
            showSubRoute: false,
            external: true,
          },
        ],
  ...
  submenuOpen: true,
  showSubRoute: false,
  submenuHdr: "Quality Control",
  submenuItems: [
    {
      label: "Vehicle Inspections",
      link: "/quality-control/vehicle-inspections",
      icon: "truck-inspection",
      showSubRoute: false,
      submenu: false,
    },
  ],
