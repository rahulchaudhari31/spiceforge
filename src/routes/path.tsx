...
import Scrollbar from "../feature-module/uiinterface/advancedui/scrollbar";
import Links from "../feature-module/uiinterface/links";
import ListGroup from "../feature-module/uiinterface/listGroup";



const VehicleInspections = lazy(
  () => import("../feature-module/quality-control/vehicle-inspection")
);
const InspectionForm = lazy(
  () => import("../feature-module/quality-control/vehicle-inspection/components/InspectionForm")
);
const InspectionReview = lazy(
  () => import("../feature-module/quality-control/vehicle-inspection/components/InspectionReview")
);
const InspectionDetails = lazy(
  () => import("../feature-module/quality-control/vehicle-inspection/components/InspectionDetails")
);
...
const CustomerProfile = lazy(
  () => import("../feature-module/people/customers/CustomerProfile")
);
...
const FacilityManagement = lazy(
  () => import("../feature-module/people/warehouses")
);
...
{
  id: 301,
  path: routes.vehicleInspections,
...
{
  id: 302,
  path: routes.vehicleInspectionCreate,
  name: "vehicle-inspection-create",
  element: <InspectionForm />,
  route: Route,
},
{
  id: 303,
  path: routes.vehicleInspectionEdit,
  name: "vehicle-inspection-edit",
  element: <InspectionForm />,
  route: Route,
},
{
  id: 304,
  path: routes.vehicleInspectionReview,
  name: "vehicle-inspection-review",
  element: <InspectionReview />,
  route: Route,
},
{
  id: 305,
  path: routes.vehicleInspectionDetails,
