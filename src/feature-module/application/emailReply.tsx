                      ...
                      <div className="card-body">
                        <div>
                          ...
                          <p className="text-dark">
                            ...
                            progress and next steps for Project. We have reached
                            a critical milestone, and I believe a discussion
                            will help align our efforts and ensure we are on
                            track to meet our goals.
                          </p>
                          <p className="text-dark">
                            am available on Tuesday and Thursday afternoons, but
                            I am flexible and can adjust to a time that suits
                            you best
                          </p>
                          <p className="text-dark">
                        ...
                        <div className="d-flex align-items-center email-attach">
                          <Lightbox
                            ...
                            slides={[
                              {
                                src: "src/assets/img/media/email-attach-big-01.jpg",
                              },
                              {
                                src: "src/assets/img/media/email-attach-big-02.jpg",
                              },
                              {
                                src: "src/assets/img/media/email-attach-big-03.jpg",
                              },
                            ]}
                          />
                          <Link
                    ...
                    <div className="card shadow-none">
                      <div className="card-body">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            Best regards <br />
                            <b className="fw-medium d-inline-flex mt-1">
                              Arman
                            </b>
                          </p>
                        </div>
