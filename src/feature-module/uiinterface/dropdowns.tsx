    ...
    <div className="row">
          ...
          <div className="card-body">
            <div className="d-flex flex-wrap gap-2">
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-secondary dropdown-toggle"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Secondary
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-info dropdown-toggle"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Info
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-warning dropdown-toggle"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Warning
          ...
          <div className="card-body">
            <div className="d-flex flex-wrap gap-2">
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-primary dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Primary
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-secondary dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Secondary
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-success dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Success
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-info dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Info
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-warning dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Warning
              ...
              <div className="btn-group">
                <button
                  type="button"
                  className="btn btn-soft-danger dropdown-toggle rounded-pill"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                  Danger
      ...
      <div className="col-xl-6">
        <div className="card">
          ...
          <div className="card-body">
            <p>
              You can use the <code>autoClose</code> option to change this
      ...
      <div className="col-xl-6">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-muted">
              To align <strong>left</strong> the dropdown menu with the given
              breakpoint or larger, add <code>.dropdown-menu-end</code> and{" "}
              <code>
            ...
            <div className="row">
              <div className="col-auto">
                <div className="dropdown">
                  ...
                  <ul
                    className="dropdown-menu"
                    aria-labelledby="dropdownWithoutArrow"
                  >
                    <li>
                      <Link className="dropdown-item" to="#">
                        Action
          ...
          <div className="card-body">
            ...
            <div className="btn-group">
              <div className="btn-group dropstart" role="group">
                <button
                  type="button"
                  className="btn btn-secondary dropdown-toggle dropdown-split dropdown-toggle-split"
                  data-bs-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                >
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="btn-group">
              ...
              <div
                className="dropdown-menu p-3 text-muted"
                style={{ maxWidth: 200 }}
              >
                <p>
